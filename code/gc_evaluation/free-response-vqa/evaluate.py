"""
DALPHIN Free-Response VQA Evaluation Script

Evaluates case-specific free-response predictions against ground truth.
Computes average similarity scores per data subset (full, reader, semi) and per category and subspecialty (full set only).
...
class DalphinFreeResponseEvaluation:
    ...
    def evaluate(self) -> dict:
        ...
        gt_df = gt_df[gt_df["question-id"].str.endswith("open")]
        ...
        for _, row in combined_df.iterrows():
            ...
            for metric in METRIC_COLUMNS:
                ...
                category_scores[category][metric].append(value)
...
# --- Main Execution ---
def main():
    evaluator = DalphinFreeResponseEvaluation(INPUT_DIRECTORY)
